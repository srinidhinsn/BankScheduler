...
public class QueryConstants {
    ...
    public static String GET_REM_ACCT = "select fd.fd_acno as sb_ano, fd.fd_prin as sb_bal,t.fd_dot as sb_dot, t.fd_part as sb_part, t.head as head,"+
    " fd.fd_dor as pg_dom, fd.fd_doa as pg_isd, fd.fd_prin as pg_con, fd.fd_int as pg_int, fd.fd_amt as sb_val from fd_dep_det fd, fd_master m, fd_trans t where"+
    " m.cno = ? and m.fd_acno=fd.fd_acno and fd.fd_doa <= sysdate and fd.fd_acno=t.fd_acno"+
    " union"+
    ...
    " from sl_master m, sl_ledger l where m.hl_lano =l.sl_ano and m.cno=?"+
    " union"+
    ...
    " from sb_trans tran, pig_master master where tran.sb_ano = master.pg_acno and"+
    " master.cno = ? and master.pg_dom >= sysdate order by sb_ano, sb_dot desc";
}
